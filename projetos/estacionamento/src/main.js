var EstacionamentoFront = /** @class */ (function () {
    ...
    EstacionamentoFront.prototype.render = function () {
        ...
        this.estacionamento.patio.forEach(function (c) { 
            return _this.adicionar(c); 
        });
    };
...
var Estacionamento = /** @class */ (function () {
    ...
    Estacionamento.prototype.encerrar = function (info) {
        ...
        if (!confirm(msg))
            return;
        this.patio = this.patio.filter(function (carro) { 
            return carro.placa !== info.placa; 
        });
        this.salvar();
    };
